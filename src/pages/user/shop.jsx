...
const Shop = () => {
  ...
  const filters = {
    ...
    Type: ["Vegetarian", "Non-Veg", "Vegan", "Gluten-Free", "Dairy-Free", " Hala"],
    Ratings: ["5 stars", "4 stars ", "3 stars", "2 stars", "1 star"],
    Toppings: ["Vegetables", "Cheese", "Proteins", "spice"],
  };
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        if (data.meals) {
          const validProducts = data.meals.map((meal) => ({
            id: meal.idMeal, // Correct
            name: meal.strMeal,
      ...
      <div className="relative h-[40vh] bg-emerald-600 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-xl">Discover your perfect taste</p>
          </div>
        </div>
      </div>
              ...
              >
                {filteredProducts.slice(0, loadMore).map((product, index) => (
                  <motion.div
                    ...
                    onClick={() => navigate(`/product/${product.id || 'default-id'}`)}
                  ...
                  >
                    ...
                    <div className={`p-4 ${viewMode === "list" ? "flex-1" : ""}`}>
                      ...
                      <button
                        ...
                        className="w-full bg-black text-white py-2 rounded-full hover:bg-gray-800 transition-colors flex items-center justify-center gap-2"
                      >
